...
import { Shield, Building2, MapPin, Users, Heart, Hospital, ChevronRight, Globe, TrendingUp, Activity, Phone, Mail, Star, CheckCircle, Menu, X } from 'lucide-react';
  ...
  const dashboards = [
    {
      ...
      description: language === 'hi' ? 'राज्य स्तरीय NRC कार्यक्रम प्रबंधन और निगरानी' : 'State-level NRC program management and oversight',
      icon: Shield,
    ...
    },
    {
      ...
      description: language === 'hi' ? 'जिला स्तरीय NRC संचालन और समन्वय' : 'District-level NRC operations and coordination',
      icon: Building2,
    ...
    },
    {
      ...
      description: language === 'hi' ? 'ब्लॉक स्तरीय कार्यान्वयन और डेटा संग्रह' : 'Block-level implementation and data collection',
      icon: MapPin,
    ...
    },
    {
      ...
      description: language === 'hi' ? 'क्षेत्र पर्यवेक्षण और गुणवत्ता आश्वासन' : 'Field supervision and quality assurance',
      icon: Users,
    ...
    },
    {
      ...
      description: language === 'hi' ? 'बाल देखभाल डेटा प्रविष्टि और रिपोर्टिंग' : 'Child care data entry and reporting',
      icon: Heart,
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="border-l-2 border-border pl-4">
                <h1 className="text-base md:text-xl font-bold text-primary leading-tight">
                  {language === 'hi' ? 'छत्तीसगढ़ पोषणीय पुनर्वास केंद्र' : 'Chhattisgarh Nutrition Rehabilitation Centers'}
                </h1>
                <p className="text-xs md:text-sm text-muted-foreground leading-tight">
                  {language === 'hi' ? 'छत्तीसगढ़ सरकार - डिजिटल प्रबंधन प्रणाली' : 'Government of Chhattisgarh - Digital Management System'}
                </p>
                <div className="flex items-center gap-2 mt-1">
                  <Badge className="bg-success text-success-foreground text-xs">Digital India</Badge>
                  <Badge className="bg-accent-light text-accent text-xs hidden md:inline-flex">Blockchain Secured</Badge>
                </div>
              </div>
            </div>
            <button
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 leading-tight">
              {language === 'hi' ? 'बाल पोषण प्रबंधन का डिजिटल परिवर्तन' : 'Digital Transformation of Child Nutrition Management'}
            </h2>
            <p className="text-base md:text-xl mb-6 md:mb-8 text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed">
              {language === 'hi' ? 'छत्तीसगढ़ राज्य में अत्याधुनिक तकनीक, पारदर्शी शासन और साक्ष्य-आधारित हस्तक्षेप के माध्यम से बाल कल्याण को आगे बढ़ाना' : 'Advancing child welfare through cutting-edge technology, transparent governance, and evidence-based interventions across Chhattisgarh'}
            </p>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base md:text-xl text-muted-foreground max-w-3xl mx-auto">
              {language === 'hi' ? 'अपनी भूमिका के लिए उपयुक्त डैशबोर्ड का चयन करें और प्रमाणीकरण के साथ लॉगिन करें' : 'Select the appropriate dashboard for your role and login with authentication'}
            </p>
            ...
            <CardContent className="p-6 md:p-8">
              <div className="text-center">
                ...
                <p className="text-sm md:text-base text-foreground mb-4">
                  {language === 'hi' ? 'सभी डेमो खातों के लिए पासवर्ड का उपयोग करें: ' : 'Use password for all demo accounts: '}
                  <span className="font-mono bg-accent text-accent-foreground px-3 py-1 rounded font-bold">admin123</span>
                </p>
                <p className="text-xs md:text-sm text-muted-foreground mb-4">
                  {language === 'hi' ? 'किसी भी डैशबोर्ड कार्ड पर क्लिक करें और ऊपर दिए गए ईमेल और पासवर्ड के साथ लॉगिन करें' : 'Click on any dashboard card and login with the email shown and password above'}
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-muted-foreground text-xs md:text-sm leading-relaxed">
                {language === 'hi' ? 'नवीन प्रौद्योगिकी समाधानों के माध्यम से डिजिटल शासन को सशक्त बनाना' : 'Empowering digital governance through innovative technology solutions'}
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-xs md:text-sm text-muted-foreground">
                <li><a href="#" className="hover:text-background govt-transition">{language === 'hi' ? 'फंड आवंटन' : 'Fund Allocation'}</a></li>
                <li><a href="#" className="hover:text-background govt-transition">{language === 'hi' ? 'स्वास्थ्य निगरानी' : 'Health Monitoring'}</a></li>
                <li><a href="#" className="hover:text-background govt-transition">{language === 'hi' ? 'प्रगति ट्रैकिंग' : 'Progress Tracking'}</a></li>
                <li><a href="#" className="hover:text-background govt-transition">{language === 'hi' ? 'रिपोर्ट जनरेशन' : 'Report Generation'}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4 text-sm md:text-base">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="text-center md:text-right">
                <p className="text-muted-foreground text-xs md:text-sm mb-1">
                  {language === 'hi' ? "© 2025 छत्तीसगढ़ सरकार। सभी अधिकार सुरक्षित।" : "© 2025 Government of Chhattisgarh. All rights reserved."}
                </p>
                <p className="text-muted-foreground/70 text-[10px] md:text-xs">
                  {language === 'hi' ? "डिजिटल इंडिया पहल के तहत विकसित | संस्करण 2.1.0" : "Developed under Digital India Initiative | Version 2.1.0"}
                </p>
              </div>
            </div>
          </div>
